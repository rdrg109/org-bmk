...
(defvar org-url-bmk-frontend 'tridactyl
  ...
  files `org-url-bmk-file-bookmarks' and
  `org-url-bmk-file-search-engines'.")

(defvar org-url-bmk-files '("~/my/org/Bookmark manager/Bookmarks.org")
  "Org files which stores the bookmarks.")

(defvar org-url-bmk-file-bookmarks "~/.config/tridactyl/tridactyl-bookmarks.vim"
...
(defvar org-url-bmk-file-search-engines "~/.config/tridactyl/tridactyl-search-engines.vim"
  "File in which search engines are to be saved.

Don't modify this file manually since its content is deleted
3after executing `org-url-bmk-export-search-engines'.")
